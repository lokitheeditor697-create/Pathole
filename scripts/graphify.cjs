...
const architecturalFlows = [
  ...
  { source: 'server.ts', target: 'detector/potbot_yolov8m.pt', label: 'PotBot Dedicated Pothole Weights' },
  { source: 'src/App.jsx', target: 'src/components/Header.jsx', label: 'Tri-Model Mode & Navigation' },
  ...
  { source: 'src/App.jsx', target: 'src/components/AIPerformanceView.jsx', label: 'Tri-Model Governance & mAP' },
